...
const PRIME_SCALE_MULTIPLIER = 50;
...
const GOAT_CHARGE_SPEED_MULTIPLIER = 50;
const GOAT_CHARGE_KNOCKBACK_VELOCITY = 1000;
const GOAT_CHARGE_VERTICAL_BOOST = -300;
const GOAT_STUN_DURATION = 2.5;
const CONO_ID = "Cono";
const CONO_PHANTOM_DURATION = 5;
const CONO_PHANTOM_COOLDOWN = 18;
const CONO_STUN_DURATION = 7.5;
const POWER_KEYS = {
  p1: "Digit1",
  p2: "Digit7",
};
